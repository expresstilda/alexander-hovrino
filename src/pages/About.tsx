...
const About = () => {
  ...
  const team = [
    ...
    },
    {
      ...
      description:
        "Михаил присоединился к команде в 2016 году, имея за плечами опыт работы инженером в судоремонтной компании. С раннего детства увлекается рыбалкой благодаря деду, с которым осваивал водоемы Подмосковья. Сегодня Михаил — один из лучших специалистов по установке и настройке троллинговых моторов в России.\n\nВ 2023 году Михаил занял 1 место в командных соревнованиях по зимней рыбалке на озере Селигер, где его команда использовала специальные системы подледного сканирования, установленные им же лично. Регулярно проводит бесплатные мастер-классы для клиентов по правильной установке и настройке оборудования.",
      specialization:
    ...
    },
    {
      ...
      description:
        "Дмитрий работает в команде с 2018 года и за это время помог более 1500 клиентов собрать идеальный комплект оборудования для их лодок. Спокойный, внимательный и терпеливый, он умеет подобрать решение даже для самого требовательного клиента.\n\nДмитрий — профессиональный гид по рыбалке с 10-летним стажем. Каждое лето проводит на северных реках, где водит туристов на рыбалку и тестирует новое оборудование в экстремальных условиях. В 2024 году его лодка стала первой, полностью оснащенной системами Sionyx для ночной рыбалки.",
      specialization:
  ...
  const testimonials = [
    {
      name: "Андрей",
      location: "Москва",
      text: "Приехал в шоурум с планшетом и ручкой, на котором нарисовал свою лодку с пометками. Александр лично провел со мной 3 часа, показал все нюансы установки эхолота и помог подобрать комплект, который до сих пор работает идеально. Это не магазин, это команда энтузиастов своего дела!",
    },
    {
      name: "Сергей",
      location: "Санкт-Петербург",
      text: "Покупал оборудование через Авито, но даже дистанционно получил такой уровень поддержки, как будто находился в шоуруме. Михаил звонил каждые полчаса во время установки, объясняя каждый шаг. Теперь рекомендую только их.",
    },
    {
      name: "Екатерина",
      location: "Новосибирск",
      text: "Как женщина-рыбак, я опасалась, что со мной будут разговаривать свысока. Но Дмитрий нашел подход, подобрал простое в использовании оборудование и даже научил меня некоторым трюкам. Теперь моя лодка оснащена лучше, чем у мужа!",
    },
  ];
      ...
      <section className="py-20 bg-secondary">
        <div className="container mx-auto px-4">
          ...
          <p className="text-lg font-inter leading-relaxed mb-12 max-w-4xl mx-auto text-center">
            В 2010 году Александр Ховрино основал компанию с простой миссией —
